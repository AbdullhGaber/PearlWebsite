...
<body>
            ...
            <div class="authWrapper2">
                <form class="p-4">
                    ...
                    <div class="mb-3" id="fnameInputDiv">
                        ...
                        <p class="invalid-feedback ms-2" id="fnameError"></p>
                        <span id="fnameIcon">
                    ...
                    <div class="mb-3" id="lnameInputDiv">
                        ...
                        <p class="invalid-feedback ms-2" id="lnameError"></p>
                        <span id="lnameIcon">
                            <i class="fas fa-user"></i>
                        </span>
                    </div>
                    <div class="mb-3" id="titleInputDiv">
                        ...
                        <p class="invalid-feedback ms-2" id="titleError"></p>
                        <span id="titleIcon">
                    ...
                    <div class="mb-3" id="emailInput">
                        ...
                        <p class="invalid-feedback ms-2" id="emailError"></p>
                        <span id="emailIcon">
                    ...
                    <div class="mb-3" id="lblInputPassWrapper">
                        <div class="input-group" id="inputSpanWrapper">
                            <div id="inputPassword">
                                ...
                                <p class="invalid-feedback ms-2" id="passwordError"></p>
                                <i class="fas fa-eye" id="showPass" onclick="handleTogglePasswordVisibility()"></i>
                            </div>
                            <div class="mt-2">
                                <p class="ms-2" id="PassErrorMsg"></p>
                            </div>
                    ...
                    <div class="mb-3" id="dobInput">
                        ...
                        <p class="invalid-feedback ms-2" id="dobError"></p>
                    </div>
                    <div class="mb-3" id="phoneInput">
                        ...
                        <p class="invalid-feedback ms-2" id="phoneError"></p>
                        <span id="phoneIcon">
                    ...
                    <div class="mb-3 rounded-2 form-control" id="licenseInput">
                        ...
                        <p class="invalid-feedback ms-2" id="licenseError"></p>
                        <span id="licenseIcon">
                            <i class="far fa-clipboard"></i>
                        </span>
                    </div>
                    <a href="second register.html" class="arrow-button float-end">
    ...
    <script src="{{ asset('./assets/js/first register.js') }}"></script>
