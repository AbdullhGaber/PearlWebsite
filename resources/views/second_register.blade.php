...
<body>
                ...
                <form class="p-4" onsubmit="handleVerifyOTP(event)">
                    ...
                    <div class="text-center">
                        ...
                        <div class="arrow-buttons">
                            <a href="first register.html" class="arrow-button float-start">
                                <i class="fa fa-arrow-left"></i>
                            </a>
                            <a href="third register.html" class="arrow-button float-end">
    ...
    <script src="./assets/js/secondRegister.js"></script>
